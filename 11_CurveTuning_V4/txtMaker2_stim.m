...
for i = 1:64
    ...
    data_row = {num2str(i), '1', num2str(block), 'CurveTuning_V4', sprintf('fix(%.2f,%.2f)',fix(1), fix(2))};
    for j = ((i-1)*10 + 1):(i*10)
        data_row{end+1} = sprintf('pic(stim%03d.png,%.2f,%.2f,%.2f,%.2f)', j, rf(1), rf(2), img_size(1), img_size(2));
    end
