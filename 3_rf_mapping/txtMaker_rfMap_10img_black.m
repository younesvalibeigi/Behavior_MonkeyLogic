...
stim_rf_seq = [];
for i=1:10
    num_b = 1:25; num_w = 26:50;
    num_b = num_b(randperm(length(num_b))); num_w = num_w(randperm(length(num_w)));
    for jj = 1:25
        stim_rf_seq = [stim_rf_seq num_b(jj)];
    end
end
% Define the file name
filename = 'stim_rf_seq_5X5_B.txt';
...
% Define the file name
filename = 'stim_rf_seq_5X5_B_10img.txt';
...
filename = 'rf_mapping_5X5_black.txt';
